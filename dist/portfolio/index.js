...
function requireScheduler_production() {
  ...
  (function(exports) {
    ...
    if ("function" === typeof localSetImmediate)
      ...
      var channel2 = new MessageChannel(), port = channel2.port2;
...
function Navigation() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: `fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-background/80 backdrop-blur-md border-b border-border/50" : "bg-transparent"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: "text-xl font-bold gradient-text font-mono hover:scale-105 transition-transform duration-200",
          children: "<DevPortfolio />"
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-10 flex items-baseline space-x-8", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            item.label,
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 left-0 w-0 h-0.5 bg-accent-gradient group-hover:w-full transition-all duration-300" })
          ]
        },
        item.label
      )) }) }),
    ...
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 pt-2 pb-3 space-y-1 bg-background/95 backdrop-blur-md rounded-lg mt-2 border border-border/50", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => scrollToSection(item.href),
...
const profileImage = "/assets/profile-jerry-BQIfZmAB.jpg";
function Hero() {
  const scrollToSection = (href) => {
    const element = document.querySelector(href);
    if (element) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "hero", className: "min-h-screen flex items-center justify-center relative overflow-hidden grid-pattern", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-1/4 w-20 h-20 border border-primary/20 rotate-45 float-animation" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3/4 right-1/4 w-16 h-16 border border-accent/20 rotate-12 float-animation animate-delay-2000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 right-1/3 w-12 h-12 border border-primary/15 rotate-45 float-animation animate-delay-4000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 left-1/3 w-24 h-24 border border-primary/10 -rotate-12 float-animation animate-delay-1000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 right-1/4 w-10 h-10 border border-accent/10 rotate-30 float-animation animate-delay-3000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/3 left-1/5 w-8 h-8 border border-primary/10 rotate-45 float-animation animate-delay-5000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2/3 right-1/5 w-14 h-14 border border-accent/15 -rotate-20 float-animation animate-delay-2500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/5 right-1/2 w-6 h-6 border border-primary/5 rotate-15 float-animation animate-delay-1500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2/5 left-2/3 w-4 h-4 border border-accent/5 rotate-30 float-animation animate-delay-3500" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 text-center lg:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-32 h-32 md:w-48 md:h-48 rounded-full bg-slate-700 overflow-hidden glass-card p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: profileImage,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-4 rounded-full border-2 border-primary/20 animate-spin animate-duration-8000" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-8 rounded-full border border-accent/10 animate-spin animate-duration-12000 animate-reverse" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl lg:text-6xl font-bold text-foreground mb-6 leading-tight", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text lg:text-7xl", children: "Jerry James" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl md:text-2xl font-normal lg:font-light text-muted-foreground mb-8 leading-relaxed max-w-2xl", children: "AI Engineer & Full-Stack Developer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hidden xs-tall:block text-sm md:text-lg lg:text-base text-muted-foreground max-w-2xl leading-relaxed", children: "I architect intelligent solutions at the intersection of AI and full-stack development. From building accessibility-first applications to automating complex workflows, I transform ideas into impactful digital experiences." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "mr-2 h-5 w-5 group-hover:animate-bounce" }),
                  "Download Resume"
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center lg:justify-start space-x-6 pt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "w-6 h-6" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              rel: "noopener noreferrer",
              className: "text-muted-foreground hover:text-primary transition-all duration-300 hover:scale-125",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "w-6 h-6" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              className: "text-muted-foreground hover:text-primary transition-all duration-300 hover:scale-125",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-6 h-6" })
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-72 h-72 rounded-full bg-slate-700 overflow-hidden glass-card p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: profileImage,
            alt: "Jerry James - Professional Developer",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute lg:bottom-8 bottom-4 left-1/2 transform -translate-x-1/2 animate-bounce", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => scrollToSection("#about"),
        className: "text-muted-foreground hover:text-primary transition-colors duration-300",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "w-8 h-8" })
      }
    ) })
  ] });
}
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-gradient-to-b from-background to-secondary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-bold mb-6", children: [
        "About ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Me" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed", children: "Passionate about building transformative solutions that create real impact" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-3 px-4 sm:px-6 py-4 sm:py-3 bg-accent/5 border border-accent/20 rounded-2xl sm:rounded-full max-w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-center sm:justify-start gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-accent/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-4 h-4 text-accent" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground text-sm sm:text-sm", children: "BS in Computer Science" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-center sm:text-left", children: "Your University" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-muted-foreground", children: "•" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-medium text-center sm:text-left", children: "GPA 3.8/4.0" })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold text-foreground", children: "My Journey" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-muted-foreground leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base", children: "With 7 years of experience spanning full-stack development and AI/ML Engineering, I've had the privilege of working with vibrant teams across enterprise companies, building everything from MVPs to large-scale applications serving millions of users." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base", children: "When I'm not coding, you'll find me contributing to open-source projects, writing technical articles, or exploring new technologies. I believe in continuous learning and sharing knowledge with the community." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold text-foreground", children: "How I Work" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6 rounded-xl group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-lg iconic mr-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-6 h-6 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground", children: "Clean Code" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Writing maintainable, scalable code that stands the test of time" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6 rounded-xl group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-lg iconic mr-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-6 h-6 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground", children: "Innovation" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Staying ahead of technology trends and implementing cutting-edge solutions" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6 rounded-xl group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-lg iconic mr-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "w-6 h-6 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground", children: "Collaboration" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Working effectively with cross-functional teams to deliver exceptional results" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-6 rounded-xl group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-lg iconic mr-4 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-6 h-6 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground", children: "Performance" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Optimizing applications for speed, accessibility, and user experience" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20 grid md:grid-cols-3 gap-8 max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center glass-card p-4 lg:p-6 rounded-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl lg:text-4xl font-bold gradient-text mb-2", children: "10+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground font-medium", children: "Projects Completed" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center glass-card p-4 lg:p-6 rounded-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl lg:text-4xl font-bold gradient-text mb-2", children: "7+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground font-medium", children: "Years Experience" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center glass-card p-4 lg:p-6 rounded-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl lg:text-4xl font-bold gradient-text mb-2", children: "30+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground font-medium", children: "Technologies Mastered" })
      ] })
    ] })
  ] }) });
}
const skillCategories = [
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-4 h-4 text-white" }),
    skills: [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-4 h-4 text-white" }),
    skills: [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Server, { className: "w-4 h-4 text-white" }),
    skills: [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Monitor, { className: "w-4 h-4 text-white" }),
    skills: [
  ...
  {
    title: "Cloud & DevOps",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Cloud, { className: "w-4 h-4 text-white" }),
    skills: [
...
function SkillCard({ category }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 rounded-xl w-96 flex-shrink-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 iconic rounded-lg bg-primary mr-3 flex items-center justify-center flex-shrink-0", children: category.icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "md:text-lg font-semibold text-foreground", children: category.title })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: category.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-1.5 px-2 rounded-md bg-secondary/30 hover:bg-primary/10 transition-colors duration-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:flex items-center gap-2 min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-normal md:font-medium text-foreground text-xs md:text-sm text-nowrap", children: skill.name })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground hidden sm:inline", children: "•" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground hidden sm:inline truncate", children: skill.description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-full border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-xs flex items-center gap-1 px-1.5 py-0.5 ml-2 flex-shrink-0 ${skill.level === "primary" ? "border-transparent bg-primary text-primary-foreground hover:bg-primary/80" : skill.level === "secondary" ? "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80" : "text-foreground border-border hover:bg-accent"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs md:text-sm", children: skill.experience }) })
    ] }, skill.name)) })
  ] });
}
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-16 bg-gradient-to-b from-background to-secondary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-3xl mx-auto", children: "Technologies I've worked with in real-world projects and professional environments" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-6", children: skillCategories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkillCard, { category }, category.title)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center glass-card p-3 rounded-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 iconic rounded-lg bg-primary mx-auto mb-2 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-4 h-4 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold gradient-text mb-1", children: "6+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground font-medium text-xs", children: "Languages" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center glass-card p-3 rounded-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 iconic rounded-lg bg-primary mx-auto mb-2 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-4 h-4 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold gradient-text mb-1", children: "6+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground font-medium text-xs", children: "AI/ML Tools" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center glass-card p-3 rounded-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 iconic rounded-lg bg-primary mx-auto mb-2 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Server, { className: "w-4 h-4 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold gradient-text mb-1", children: "6+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground font-medium text-xs", children: "Frameworks" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center glass-card p-3 rounded-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 iconic rounded-lg bg-primary mx-auto mb-2 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cloud, { className: "w-4 h-4 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold gradient-text mb-1", children: "6+" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground font-medium text-xs", children: "Cloud Tech" })
      ] })
    ] })
  ] }) });
}
...
function ExperienceCard({ experience, isExpanded, onToggle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-start group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-2 md:left-6 w-3 h-3 md:w-4 md:h-4 bg-gradient-to-r from-primary to-accent rounded-full border-2 md:border-4 border-background shadow-lg group-hover:scale-125 transition-transform duration-300 z-10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 md:left-8 top-6 md:top-8 w-4 md:w-8 h-0.5 bg-gradient-to-r from-primary/50 to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-8 md:ml-20 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-4 md:p-6 rounded-xl md:rounded-2xl transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-start sm:justify-between md:mb-4 md:gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between md:block w-full sm:w-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 md:w-16 md:h-16 rounded-lg md:rounded-xl bg-white backdrop-blur-sm border border-white/20 flex items-center justify-center shadow-lg flex-shrink-0 p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: experience.logo,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 md:hidden text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3 h-3 mr-1 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: experience.duration })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3 mr-1 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: experience.location })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg md:text-xl font-bold text-foreground mb-1 leading-tight", children: experience.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-base md:text-lg font-semibold text-primary mb-2 leading-tight", children: experience.company }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex md:flex-wrap md:items-center gap-4 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3 h-3 mr-2 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: experience.duration })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3 mr-2 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: experience.location })
              ] })
            ] })
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: `w-5 h-5 text-muted-foreground transition-transform duration-300 ${isExpanded ? "rotate-180" : ""}` })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base text-muted-foreground leading-relaxed mb-4", children: experience.description }),
      isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "transition-all duration-500 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 md:mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "text-xs md:text-sm font-semibold text-foreground mb-3 flex items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-4 h-4 mr-2 text-accent flex-shrink-0" }),
            "Key Achievements"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: experience.achievements.map((achievement, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start text-xs md:text-sm text-muted-foreground leading-relaxed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 bg-primary rounded-full mt-2 mr-3 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1", children: achievement })
          ] }, index)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "text-xs md:text-sm font-semibold text-foreground mb-3 flex items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-4 h-4 mr-2 text-accent flex-shrink-0" }),
            "Technologies Used"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 md:gap-2", children: experience.technologies.map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
...
function Experience() {
  const [expandedId, setExpandedId] = reactExports.useState(1);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "experience", className: "py-20 bg-gradient-to-b from-background via-secondary/10 to-background relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-1/6 w-32 h-32 border border-primary/10 rotate-45 float-animation animate-delay-2000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/3 right-1/4 w-24 h-24 border border-accent/10 rotate-12 float-animation animate-delay-4000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2/3 left-1/3 w-16 h-16 border border-primary/5 -rotate-12 float-animation animate-delay-1000" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8 lg:mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 lg:mb-6", children: [
          "Professional ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Journey" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base md:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed", children: "From startups to enterprise solutions, building scalable systems and leading innovative initiatives across diverse technology stacks" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 md:left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-accent to-primary opacity-30" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8 lg:space-y-12", children: experiences.map((experience) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ExperienceCard,
          {
            experience,
...
function Projects() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "py-20 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold text-foreground mb-4", children: [
        "Featured ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Projects" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-muted-foreground max-w-3xl mx-auto", children: "Innovative solutions that bridge cutting-edge technology with real-world impact" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "select",
        {
          ...
          children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: category, children: [
            category,
            " Projects"
          ] }, category))
        }
      ) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex flex-wrap justify-center gap-3", children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: () => setSelectedCategory(category),
          className: `inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-9 rounded-md px-3 transition-all duration-200 hover:scale-105 ${selectedCategory === category ? "bg-primary text-primary-foreground hover:bg-primary/90" : "border border-input bg-background hover:bg-accent hover:text-accent-foreground"}`,
          children: [
            category,
            " Projects"
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 xl:grid-cols-3 gap-8", children: filteredProjects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `glass-card rounded-xl overflow-hidden group animate-fade-in-up ${project.featured ? "md:col-span-2 xl:col-span-1" : ""}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video relative bg-gradient-to-br from-primary/20 to-accent/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: project.image,
                alt: project.title,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `inline-flex items-center rounded-full border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-xs ${project.status === "Featured" ? "border-transparent bg-primary text-primary-foreground hover:bg-primary/80" : "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80"}`, children: project.status }),
              project.featured && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center rounded-full border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary text-primary-foreground hover:bg-primary/80 text-xs", children: "Featured" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground mb-2", children: project.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary font-medium mb-3", children: project.subtitle }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: project.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-4", children: [
              project.technologies.slice(0, 4).map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              project.technologies.length > 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center rounded-full border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground text-xs bg-primary/10", children: [
                "+",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-3", children: [
              project.githubUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "w-4 h-4 mr-4" }),
                    "View Code"
                  ]
                }
              ),
              project.liveUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-4 h-4 mr-4" }),
                    "Live Demo"
                  ]
                }
              )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mt-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "Interested in collaborating on innovative projects?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 bg-gradient-to-b from-background/80 to-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-bold mb-6", children: [
        "Get In ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Touch" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-muted-foreground max-w-3xl mx-auto", children: "Ready to bring your ideas to life? Let's discuss your next project" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-8 rounded-xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold mb-6 text-foreground", children: "Send Message" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "name", className: "block text-sm font-medium text-foreground mb-2", children: "Name *" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "email", className: "block text-sm font-medium text-foreground mb-2", children: "Email *" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "email",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "subject", className: "block text-sm font-medium text-foreground mb-2", children: "Subject *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "message", className: "block text-sm font-medium text-foreground mb-2", children: "Message *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                id: "message",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-8 rounded-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold mb-6 text-foreground", children: "Contact Information" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 iconic rounded-lg bg-primary group-hover:scale-110 transition-transform duration-300 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5 text-white" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Email" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground group-hover:text-primary", children: "your.email@example.com" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                className: "flex items-center space-x-4 group hover:text-primary transition-colors duration-200",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 iconic rounded-lg bg-primary group-hover:scale-110 transition-transform duration-300 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5 text-white" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Phone" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground group-hover:text-primary", children: "+1 (234) 567-8900" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4 group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 iconic rounded-lg bg-primary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 text-white" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Location" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: "San Francisco, CA" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-8 rounded-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold mb-6 text-foreground", children: "Follow Me" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              ...
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg iconic bg-accent-gradient group-hover:scale-110 transition-transform duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "w-5 h-5 text-white" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: "GitHub" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "your-username" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opacity-0 group-hover:opacity-100 transition-opacity duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "→" }) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg iconic bg-accent-gradient group-hover:scale-110 transition-transform duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "w-5 h-5 text-white" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: "LinkedIn" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "your-profile" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opacity-0 group-hover:opacity-100 transition-opacity duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "→" }) })
                ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg iconic bg-accent-gradient group-hover:scale-110 transition-transform duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-5 h-5 text-white" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: "Blog" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "your-blog" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opacity-0 group-hover:opacity-100 transition-opacity duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "→" }) })
                ]
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-gradient-to-b from-background via-secondary/10 to-background border-t border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 md:space-y-4 text-center md:text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-xl md:text-2xl font-bold gradient-text font-mono hover:scale-105 transition-transform duration-200 inline-block", children: "<DevPortfolio/>" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base text-muted-foreground leading-relaxed", children: "Ready to collaborate on something extraordinary? I'm always excited to connect with fellow innovators and push the boundaries of what's possible with technology." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 md:space-y-4 text-center md:text-left md:mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base md:text-lg font-semibold text-foreground", children: "Quick Links" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "flex flex-wrap justify-center md:flex-col md:justify-start gap-x-6 gap-y-2 md:gap-x-0 md:space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#about", className: "text-sm md:text-base text-muted-foreground hover:text-primary transition-colors duration-200", children: "About" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#skills", className: "text-sm md:text-base text-muted-foreground hover:text-primary transition-colors duration-200", children: "Skills" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#experience", className: "text-sm md:text-base text-muted-foreground hover:text-primary transition-colors duration-200", children: "Experience" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#projects", className: "text-sm md:text-base text-muted-foreground hover:text-primary transition-colors duration-200", children: "Projects" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 md:space-y-4 text-center md:text-left md:mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base md:text-lg font-semibold text-foreground", children: "Get In Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base text-muted-foreground", children: "Ready to work together?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "mailto:your.email@example.com",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base text-muted-foreground", children: "San Francisco, CA" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 md:mt-12 pt-6 md:pt-8 border-t border-border/30 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row items-center text-center sm:text-left text-muted-foreground text-xs md:text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "© 2024 DevPortfolio. Made with" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-1 md:mx-2 text-red-500 animate-pulse", children: "♥" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "and lots of coffee." })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs md:text-sm text-muted-foreground text-center md:text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Built with React, Vite & Tailwind CSS" }) })
      ] })
    ] }) })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {}) }) }) });
}
